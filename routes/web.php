...
Route::get('/moments', [PostController::class, 'index'])->name('posts.index');
Route::get('/moments/{post:slug}', [PostController::class, 'show'])->name('posts.show');

Route::get('moment/{post:slug}', [PostController::class, 'show']);
